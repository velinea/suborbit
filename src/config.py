...
def parse_genres(raw: str):
    """Turn a comma-separated string into include/exclude lists."""
    include, exclude = [], []
...
# from .env (example: "sci-fi,drama,!action")
RAW_GENRES = os.getenv("ALLOWED_GENRES", "")
ALLOWED_INCLUDE_GENRES, ALLOWED_EXCLUDE_GENRES = parse_genres(RAW_GENRES)
